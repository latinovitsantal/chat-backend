 ...
 */
class DefaultNeoSerializer : NeoSerializer {
    ...
    private fun serializeTime(time: OffsetTime) = time.format(DateTimeFormatter.ISO_OFFSET_TIME)
    private fun serializeTime(time: OffsetDateTime): String = time.format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)
    private fun serializeTime(time: ZonedDateTime): String = time.format(DateTimeFormatter.ISO_OFFSET_DATE_TIME)
    private fun serializeTime(time: Instant): String = time.toString()
